...
ALTER TABLE `airline_database`.`person` 
CHANGE COLUMN `FIRST_NAME` `FIRST_NAME` VARCHAR(50) NOT NULL ,
CHANGE COLUMN `LAST_NAME` `LAST_NAME` VARCHAR(50) NOT NULL ,
CHANGE COLUMN `EMAIL_ADDRESSS` `EMAIL_ADDRESSS` VARCHAR(70) NOT NULL ,
CHANGE COLUMN `ADDRESS_LINE1` `ADDRESS_LINE1` VARCHAR(100) NOT NULL ,
CHANGE COLUMN `ADDRESS_LINE2` `ADDRESS_LINE2` VARCHAR(100) NULL ;
...
update PERSON set first_name='aaaaaa', last_name='xiaocelao', 
EMAIL_ADDRESSS='2', PASSPORT_NUMBER='222', ADDRESS_LINE1='2', 
ADDRESS_LINE2='2', CITY='2', STATE='2', COUNTRY='2', ZIP_CODE='2', 
PERSON_DELETED=0, birthday='1111-11-11' where person_id=0;
